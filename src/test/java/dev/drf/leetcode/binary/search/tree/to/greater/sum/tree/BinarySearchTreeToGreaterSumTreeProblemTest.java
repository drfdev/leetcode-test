...
public class BinarySearchTreeToGreaterSumTreeProblemTest {
    private final BinarySearchTreeToGreaterSumTreeProblem problem = new BinarySearchTreeToGreaterSumTreeProblem();
    ...
    void example1() {
        ...
        var result = problem.bstToGst(root);
