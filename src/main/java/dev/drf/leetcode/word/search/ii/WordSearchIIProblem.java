 ...
 */
public class WordSearchIIProblem implements Problem {
    ...
    private void dfs(int r, int c, Trie node, String word,
                     HashSet<String> res, HashSet<String> visit, char[][] board, Trie root) {
        if (r < 0 || c < 0 ||
                r == ROWS || c == COLS ||
